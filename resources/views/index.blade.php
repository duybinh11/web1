                ...
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item-separate">
                            Vào cửa hàng trong ứng dụng B-shop
                            <!-- QR code -->
                        ...
                        <li class="header__navbar-item">
                            ...
                            <a href="https://www.facebook.com/Binhgold10012004" class="header__navbar-icon-link">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <div class="modal" id="modal_1">
                            ...
                            <div class="modal__body">
                                ...
                                <!-- Register  -->
                                <div class="auth-form__register" id="register">
                                    <div class="auth-form__container">
                                        ...
                                        <form action="{{ route('handleRegister') }}" method="post">
                                            ...
                                            <div class="auth-form__form">
                                                ...
                                                <div class="auth-form__group">
                                                    <input type="password" name="pass" class="auth-form__input" placeholder="Nhập mật khẩu của bạn">
                                                </div>
                                                <div class="auth-form__group">
                                                    <input type="password" class="auth-form__input" placeholder="Nhập lại mật khẩu">
                                                </div>
                                                <div class="auth-form__group">
                                                    <input type="text" name="username" class="auth-form__input" placeholder="Username">
                                                </div>
                                                <div class="auth-form__group">
                                                    <input type="text" name="address" class="auth-form__input" placeholder="Địa Chỉ">
                                                </div>
                                                <div class="auth-form__group">
                                                    <input type="text" name="phone" class="auth-form__input" placeholder="SDT">
                                                </div>
                                            </div>
                                            <div class="auth-form__aside">
                                                <p class="auth-form__policy-text">
                                                    Bằng việc đăng ký. bạn đã đồng ý với B-shop về
                                ...
                                <!-- Login form -->
                                <form action="{{ route('handleLogin') }}" class="auth_form__login" id="login" method="post">
                                    @csrf
                                    <div class="auth-form__container">
                                        <div class="auth-form__header">
                        ...
                        <li class="header__navbar-item header__navbar-user">
                            <img src="https://cdn-icons-png.flaticon.com/128/1144/1144760.png" alt="" class="header__navbar-user-img">
                ...
                <div class="header-with-search">
                    ...
                    <div class="header__search">
                        <div class="header__search-input-swap">
                            <input id="searchInput" type="text" class="header__search-input" placeholder="Tìm kiếm sản phẩm trong shop">
                        </div>

                        <button id="searchButton" class="header__search-btn">
                            ...
                            <div class="header__cart-list  ">
                                ...
                                <ul class="header__cart-list-item">
                                    ...
                                    <li class="header__cart-item">
                                        <img src="{{ $itemCart->img }}" class="header__cart-img">
                                        <div class="header__cart-item-info">
                                            <div class="header__cart-item-head">
                                                <h5 class="header__cart-item-name">{{ $itemCart->name }}</h5>
                                                <div class="header__cart-item-price-wrap">
                                                    <span class="header__cart-item-price">{{ number_format( $itemCart->cost * ( 1 - $itemCart->sale/100 ) , 0, ',', '.')  }}đ</span>
                                                    <span class="header__cart-item-multiply">x</span>
                                                    <span class="header__cart-item-qnt">{{ $itemCart->pivot->sl }}</span>
                                                </div>
                                            </div>
                                            <div class="header__cart-item-body">
                                                ...
                                                <form action="{{ route('orderDetail' , ['id_cart' => $itemCart->pivot->id])}}">
                                                    <button class="header__cart-item-buy">Mua hàng</button>
                                                </form>
                                                <form action="{{ route('deleteCart' ,['id_cart' => $itemCart->pivot->id]) }}">
                        ...
                        <div class="header__cart-swap">
                            ...
                            <div class="header__cart-list  ">
                                ...
                                <ul class="header__cart-list-item">
                                    ...
                                    <li class="header__cart-item">
                                        <img src="{{ $order->img }}" class="header__cart-img">
                                        <div class="header__cart-item-info">
                                            <div class="header__cart-item-head">
                                                <h5 class="header__cart-item-name">{{ $order->name }}</h5>
                                                <div class="header__cart-item-price-wrap">
                                                    <span class="header__cart-item-price">{{ number_format( $order->cost * ( 1 - $order->sale/100 )   , 0, ',', '.')  }}đ</span>
                                                    <span class="header__cart-item-multiply">x</span>
                                                    <span class="header__cart-item-qnt">{{ $order->pivot->count}}</span>
                                                </div>
                                            </div>
                                            <div class="header__cart-item-body">
                                                <span class="header__cart-item-description">
                                                    Trạng thái: {{$order->pivot->state}}

                                                </span>
                                                <div class="header__cart-total">
                                                    <div class="header__cart-total-item">Tổng tiền: <span style="color:red">{{ number_format( $order->pivot->money     , 0, ',', '.')  }}đ</span></div>
                                                </div>
                                            </div>
            ...
            <div class="grid">
                <div class="grid__row app__content">
                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                <li class="category-item category-item--active">
                                    <a href="#" class="category-item__link" onclick="handleCategoryClick(this)">Tất cả</a>
                                </li>
                                <li class="category-item category">
                                    <a href="#" class="category-item__link" onclick="handleCategoryClick(this)">Kem dưỡng da</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link" onclick="handleCategoryClick(this)">Kem trị mụn</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link" onclick="handleCategoryClick(this)">Sữa rửa mặt</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link" onclick="handleCategoryClick(this)">Son môi</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link" onclick="handleCategoryClick(this)">Kem nền</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    <div class="grid__column-10">
                        <div class="home-filter">
                            ...
                            <button id="Mới nhất" onclick="handleButtonClick(this)" class="home-filter-btn btn btn--primary ">Mới nhất</button>
                            <button id="Bán chạy" onclick="handleButtonClick(this)" class="home-filter-btn btn btn--primary ">Bán chạy</button>
                            ...
                            <div class="grid">
                                <div class="grid__row">
                                    ...
                                    <div class="home-product">
                                        <div class="grid">
                                            <div class="grid__row">
                                                <iframe id="productIframe" width="1100px" height="900px" src="{{ route('subHome', ['id_category' => 0,'sort' => 'Mới nhất' ]) }}" frameborder="0" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <footer class="footer">
                        <div class="grid">
                            <div class="grid__row">
                                ...
                                <div class="grid__column-2-4">
                                    <h3 class="footer-heading">VỀ B-SHOP</h3>
                                    <ul class="footer-list">
                                        <li class="footer-item">
                                            <a href="" class="footer-item__link">
                                                Giới thiệu về B-shop
                                            </a>
                                        </li>
                                        <li class="footer-item">
                                            <a href="" class="footer-item__link">
                                ...
                                <div class="grid__column-2-4">
                                    <h3 class="footer-heading">THEO DÕI B-SHOP</h3>
                                    <ul class="footer-list">
                                        <li class="footer-item">
                                            <a href="" class="footer-item__link">
                                ...
                                <div class="grid__column-2-4">
                                    <h3 class="footer-heading">VÀO B-SHOP TRÊN ỨNG DỤNG</h3>
                        ...
                        <div class="footer__bottom">
                            <div class="grid">
                                ...
                                <div class="footer-infor__logo">
                                    ...
                                    <span class="footer-infor__logo-text">Công ty TNHHB-shop</span>
                                </div>
                                <div class="footer-infor__Address">
                                    ...
                                    <span class="footer-infor__Address-item">
                                        Số điện thoại: 098203XXXX
                                    </span>
                                    <span class="footer-infor__Address-item">
                                        &reg;2023-Bản quyền thuộc về công ty B-shop
                                    </span>
                                </div>
                ...
                <script>
                    ...
                    function handleCategoryClick(element) {
                        // Loại bỏ class 'category-item--active' từ tất cả các phần tử
                        var allCategoryItems = document.querySelectorAll('.category-item');
                        allCategoryItems.forEach(function(item) {
                            item.classList.remove('category-item--active');
                        });
                        if (element.textContent == "Kem dưỡng da") {
                            id_category = 1;
                        } else if (element.textContent == "Kem trị mụn") {
                            id_category = 2;
                        } else if (element.textContent == "Sữa rửa mặt") {
                            id_category = 3;
                        } else if (element.textContent == "Son môi") {
                            id_category = 4;
                        } else if (element.textContent == "Kem nền") {
                            id_category = 5;
                        } else {
                            id_category = 0;
                        }

                        // Thêm class 'category-item--active' cho phần tử được click
                        element.parentNode.classList.add('category-item--active');

                        // Cập nhật iframe.src với giá trị id_category mới
                        var newSrc = "{{ route('subHome', ['id_category' => ':id_category','sort' => ':filter' ]) }}";
                        newSrc = newSrc.replace(':id_category', id_category);
                        newSrc = newSrc.replace(':filter', filter);
                        iframe.src = newSrc;

                        // Thêm mã xử lý tại đây nếu bạn muốn thực hiện thêm hành động khi click vào mỗi danh mục
                    }
                    //filter
                    function handleButtonClick(element) {
                        // Thêm mã xử lý tại đây nếu bạn muốn thực hiện thêm hành động khi click vào mỗi nút
                        var buttonId = element.id;
                        if (buttonId === 'Mới nhất') {
                            filter = 'Mới nhất';
                            // console.log('Mới nhất');
                        } else if (buttonId === 'Bán chạy') {
                            filter = 'Bán chạy';
                    ...
                    document.getElementById('searchButton').addEventListener('click', function() {
                        ...
                        // Thêm mã xử lý tại đây nếu bạn muốn thực hiện thêm hành động khi click vào nút tìm kiếm
                        var newSrc = "{{ route('subHomeSearch', ['search' => ':searchValue' ]) }}";
                        newSrc = newSrc.replace(':searchValue', searchValue);
                        iframe.src = newSrc;
                    });
                </script>
