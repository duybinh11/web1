                                        ...
                                        <div class="header__cart-item-info">
                                            ...
                                            <div class="header__cart-item-body">
                                                <span class="header__cart-item-description">
                                                    ...
                                                    <!-- state order: delivering or  -->
                                                </span>
                                                <div class="header__cart-total">
                                                    <div class="header__cart-total-item">Tổng tiền: <span style="color:red">1.000.000</span></div>
                                                </div>
                                            </div>
                ...
                <div class="container">
                    ...
                    <div class="product-content">
                        ...
                        <div class="wrapper">
                            ...
                            <span class="price" id="data-total-price">{{ number_format($item->cost * (1 - $item->sale/100) , 0, ',', '.')  }}đ</span>

                            <span class="badge">{{ $item->sale }}%</span>

                            <del class="del" id="data-qty-old">{{ number_format($item->cost, 0, ',', '.')  }}đ</del>
