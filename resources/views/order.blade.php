...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/ctdh.css') }}">
                    ...
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item-separate">
                            ...
                            <div class="header__qr">
                                <a href=""> <img src="{{ asset('assets/img/img-QR.png') }}" alt="QR Code" class="header__qr-img"></a>
                                <div class="header__qr-apps">
                                    <a class="header__qr-link" href=""> <img src="{{ asset('assets/img/ing-appstore.png') }}" alt="Google play" class="header__qr-download-img"></a>
                                    <a class="header__qr-link" href=""> <img src="{{ asset('assets/img/img-ggplay.png') }}" alt="App store" class="header__qr-download-img"></a>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="product-content">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="counter-wrapper">
                                ...
                                <span class="span" id="data-qty">{{ $cart->sl }}</span>
                            ...
                            <form action="{{ route('addOrderHandle') }}" method="get">
                                ...
                                <input type="hidden" name="sl" id="slInput" value="{{ $cart->sl }}" />
